        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
            <div class="img">
                <div class="img-box h-full max-lg:mx-auto ">
                    <img src="img/items/<?= $product['id'] ?>/<?= $product['id'] ?>.png" alt="Yellow Tropical Printed Shirt image"
                ...
                <div class="data w-full max-w-xl">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-6">
                        <h6
                            ...
                            Rp<?= number_format($product['harga'], 2, ',', '.') ?></h6>
                        <div class="flex items-center gap-2">
                            <span id="stok-barang"
                                class="pl-2 font-normal leading-7 text-gray-500 text-sm "><?= $product['stok'] ?>
                                left</span>
                        </div>

                    </div>
                    <p class="text-gray-500 text-base font-normal mb-5"><?= $product['deskripsi'] ?></p>
                    <ul class="grid gap-y-4 mb-8">
                        <li class="flex items-center gap-3">
                            ...
                            <span class="font-normal text-base text-gray-900 ">100% original</span>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="font-normal text-base text-gray-900 ">Kualitas terbaik</span>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="font-normal text-base text-gray-900 ">Bebas pengiriman</span>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="font-normal text-base text-gray-900 ">Kepuasan terjamin</span>
                        </li>
                    </ul>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 py-8">
                        <div class="flex sm:items-center sm:justify-center w-full">
                            <button onclick="decreaseAmount(); return false;"
                            ...
                            <form action="/cart" method="POST" id="form-keranjang">
                                <input type="hidden" name="id_akun" value="<?= $_SESSION['user']['id'] ?? '' ?>">
                                ...
                                <input type="number"
                                    ...
                                    name="jumlah" id="jumlah" value="1" min="1" max="<?= $product['stok'] ?>" required>
                            </form>
                            <button onclick="increaseAmount(); return false;"
